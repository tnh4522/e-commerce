                        ...
                        <div className="section-header d-flex flex-wrap justify-content-between my-5">
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="swiper-buttons">
                                    <button className="swiper-prev best-selling-products-carousel-prev btn btn-primary">❮</button>
                                    <button className="swiper-next best-selling-products-carousel-next btn btn-primary">❯</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="products-carousel swiper">
                            <div className="swiper-wrapper">
                                <Swiper
                                    ...
                                    navigation={{
                                        nextEl: '.best-selling-products-carousel-next',
                                        prevEl: '.best-selling-products-carousel-prev',
                                    }}
                                    loop={true}
                                    centeredSlides={true}
                                    autoplay={{
